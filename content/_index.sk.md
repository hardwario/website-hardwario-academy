...
projects = [
  ...
  { cat = "automation", category = "Automatizácia", title = "Bezdrôtový inteligentný LED pásik", text = "Ovládaj LED pásik na diaľku – farby, jas aj efekty cez Node-RED a Blynk.", benefit = "Ovládanie zariadenia na diaľku a prepojenie hardvéru s aplikáciou.",      image = "smart-led-strip.webp", kit = ["Control Set", "Radio Dongle", "LED pásik"],     pkg = "CLASS",   link_href = "https://stem.hardwario.com/projects/radio-smart-led-strip" },
...
steps = [
  ...
  { num = "02", title = "PREJDITE MINI COURSE", text = "Hotové kurzy na STEM portáli. Prevedú ťa zložením, nahraním firmvéru a prvou ukážkou dát. Bez vlastnej prípravy materiálov." },
